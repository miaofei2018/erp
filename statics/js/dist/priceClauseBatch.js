...
var api = frameElement.api,
	...
	THISPAGE = {
		...
		loadGrid: function() {
			...
			$grid.jqGrid({
				url: "../basedata/priceClause?action=list",
		...
		reloadData: function(a) {
			addList = {}, $grid.jqGrid("setGridParam", {
				url: "../basedata/priceClause/findByNumberOrName?action=findByNumberOrName",
				datatype: "json",
				postData: a
			}).trigger("reloadGrid")
		},
		addEvent: function() {
			...
			$("#search").click(function() {
				queryConditions.skey = "请输入编号或名称" === a.$_matchCon.val() ? "" : a.$_matchCon.val(), THISPAGE.reloadData(queryConditions)
