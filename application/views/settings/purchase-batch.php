...
<div class="container fix p20">
	  <div class="mod-search m0 cf">
	    <div class="fl">
	      <ul class="ul-inline">
	        <li>
	          <input type="text" id="matchCon" class="ui-input ui-input-ph" value="请输入单据编号或供应商名称">
	        </li>
...
<script src="<?php echo base_url()?>statics/js/dist/purchaseBatch.js?ver=201510241557"></script>
</body>
</html>