...
<header class="mui-bar-nav" id="header">
    ...
    <div style="float:left;width:calc(100% - 160px);color:#fff;text-align:center;font-size:19px;line-height:63.97px;vertical-align:middle">客户订单</div>
...
<div id="detailView" style="display:none;position: fixed;z-index:100;width:100%;height:100%;background:#fff;font-size: 18px;">
    <div style="background: #FC605A;top: 0;right: 0;left: 0;height: 63.98px;">
        ...
        <div id="detailText" style="float:left;width:calc(100% - 160px);color:#fff;text-align:center;font-size:19px;line-height:63.97px;vertical-align:middle">客户订单录入</div>
...
function loadSoList(page){
	...
	var data = {page:page,rows:10,curStatus:curStatus,transType:150601};
	$.ajax({
        type: "post",
